...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		List <String> syllableList = getTokens("[aeiouyAEIOUY]+");
		List <String> loneEList = getTokens("[^aeiouyAEIOUY]+[Ee]\\b");
		List <String> singEList = getTokens("\\b[^aeiouyAEIOUY]*[Ee]\\b");
		int size = syllableList.size() - (loneEList.size() - singEList.size());
	    return size;
	}
