...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		System.out.println("word1 is " + root.getWord());
		
		while (!queue.isEmpty() 
				&& !find) {
			System.out.println("queue is: " + printQueue(queue));
			WPTreeNode curr = queue.remove(0);
			System.out.println("curr is " + curr.getWord());
			List<String> neighbors = nw.distanceOne(curr.getWord(), true);
			System.out.println("One way word for \"" + curr.getWord() + "\"" + " are: " + neighbors);
	...
	private String printQueue(List<WPTreeNode> list) {
	 ...
	 public static void main(String[] args) {
         ...
         System.out.println("Your path was: " + path + ".\n") ;
