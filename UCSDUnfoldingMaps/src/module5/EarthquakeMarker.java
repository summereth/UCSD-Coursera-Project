...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	private static final float TITLE_WIDTH = 0;

	private static final float TITLE_HEIGHT = 0;
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		pg.fill(250, 248, 220);
		pg.rect(x, y + 20, TITLE_WIDTH, TITLE_HEIGHT);
		pg.fill(0, 0, 0);
		pg.text(getProperty("title").toString(), x, y + 30 );
